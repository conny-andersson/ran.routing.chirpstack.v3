...
| CHIRPSTACK_BATCH_SIZE                  |          | 1                       | Concurrent number or requests when getting device activation and keys from ChirpStack. Please closely monitor load on Chirpstack API.                                                 |
